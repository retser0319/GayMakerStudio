if (status == "idle" or status == "stunned")
	draw_sprite_ext(spr_ch_idle, image_index, x, y, image_xscale, image_yscale, image_angle, blend, 1);
else if (status == "jump")
	draw_sprite_ext(spr_ch_jump, image_index, x, y, image_xscale, image_yscale, image_angle, blend, 1);
else if (status == "run")
	draw_sprite_ext(spr_ch_run, image_index, x, y, image_xscale, image_yscale, image_angle, blend, 1);
else if (status == "wall")
	draw_sprite_ext(spr_ch_wall, image_index, x, y, -image_xscale, image_yscale, image_angle, blend, 1);
	...
	draw_sprite_ext(spr_ch_attack_2, image_index, x, y, image_xscale, image_yscale, image_angle, blend, 1); }
