...
{
	if (attackNum == 1)
		draw_sprite_ext(spr_ch_attack_1, image_index, x, y, dir, 1, image_angle, c_white, 1);
	else if (attackNum == 2)
		draw_sprite_ext(spr_ch_attack_2, image_index, x, y, dir, 1, image_angle, c_white, 1);
	else if (attackNum == 3)
		draw_sprite_ext(spr_ch_attack_3, image_index, x, y, dir, 1, image_angle, c_white, 1);
}
else if (status == "dash")
